...
<nav class="navbar no-margin-bottom bootsnav alt-font bg-white sidebar-nav sidebar-nav-style-1 navbar-expand-lg">
  ...
  <div class="col-12 sidenav-header">
      <div class="logo-holder">
          <a href="index.html" class="display-inline-block logo"><img alt="Pofo" src="images/logo.png" data-rjs="images/logo@2x.png" /></a>
      </div>
      <!-- end logo -->
  ...
  <div class="col-12 position-absolute top-auto bottom-0 left-0 width-100 padding-20px-bottom sm-padding-15px-bottom">
      <div class="footer-holder">
          ...
          <div class="text-medium-gray text-extra-small border-top border-color-extra-light-gray padding-twelve-top sm-padding-15px-top">&COPY; 2019 POFO. All rights reserved</div>
      </div>
  </div>
</nav>
<!-- end navigation --> 
      ...
      <div class="container">
          <div class="row">
              <div class="col-12 wow fadeIn">
                  <span class="head-text text-extra-dark-gray font-weight-300 width-80 d-block line-height-90 lg-width-100">
